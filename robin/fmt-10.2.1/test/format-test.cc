...
EXPECT_EQ(fmt::detail::compute_width("вожык"),
5);
}
...
"{");
EXPECT_EQ(fmt::format("before {{"),
"before {");
EXPECT_EQ(fmt::format("{{ after"),
"{ after");
EXPECT_EQ(fmt::format("before {{ after"),
"before { after");
...
EXPECT_EQ(fmt::format("{0}", 42),
"42");
EXPECT_EQ(fmt::format("before {0}", 42),
"before 42");
EXPECT_EQ(fmt::format("{0} after", 42),
"42 after");
EXPECT_EQ(fmt::format("before {0} after", 42),
"before 42 after");
EXPECT_EQ(fmt::format("{0} = {1}", "answer", 42),
"answer = 42");
EXPECT_EQ(fmt::format("{1} is the {0}", "answer", 42),
"42 is the answer");
EXPECT_EQ(fmt::format("{0}{1}{0}", "abra", "cad"),
"abracadabra");
}
...
EXPECT_EQ(fmt::format("{0:{width}}", -42, fmt::arg("width", 4)),
" -42");
EXPECT_EQ("st",
fmt::format("{0:.{precision}}", "str", fmt::arg("precision", 2)));
EXPECT_EQ(fmt::format("{} {two}", 1, fmt::arg("two", 2)),
"1 2");
EXPECT_EQ("42",
...
EXPECT_EQ(fmt::format("{0:<4}", 42),
"42  ");
EXPECT_EQ(fmt::format("{0:<4o}", 042),
"42  ");
EXPECT_EQ(fmt::format("{0:<4x}", 0x42),
"42  ");
EXPECT_EQ(fmt::format("{0:<5}", -42),
"-42  ");
EXPECT_EQ(fmt::format("{0:<5}", 42u),
"42   ");
EXPECT_EQ(fmt::format("{0:<5}", -42l),
"-42  ");
EXPECT_EQ(fmt::format("{0:<5}", 42ul),
"42   ");
EXPECT_EQ(fmt::format("{0:<5}", -42ll),
"-42  ");
EXPECT_EQ(fmt::format("{0:<5}", 42ull),
"42   ");
EXPECT_EQ(fmt::format("{0:<5}", -42.0),
"-42  ");
EXPECT_EQ(fmt::format("{0:<5}", -42.0l),
"-42  ");
EXPECT_EQ(fmt::format("{0:<5}", 'c'),
"c    ");
EXPECT_EQ(fmt::format("{0:<5}", "abc"),
"abc  ");
EXPECT_EQ(fmt::format("{0:<8}", reinterpret_cast<void *>(0xface)),
"0xface  ");
}
...
EXPECT_EQ(fmt::format("{0:^5}", 42),
" 42  ");
EXPECT_EQ(fmt::format("{0:^5o}", 042),
" 42  ");
EXPECT_EQ(fmt::format("{0:^5x}", 0x42),
" 42  ");
EXPECT_EQ(fmt::format("{0:^5}", -42),
" -42 ");
EXPECT_EQ(fmt::format("{0:^5}", 42u),
...
EXPECT_EQ(fmt::format("{0:+}", 42l),
"+42");
EXPECT_THROW_MSG((void) fmt::format(runtime("{0:+}"), 42ul), format_error,
                 "invalid format specifier");
EXPECT_EQ(fmt::format("{0:+}", 42ll),
"+42");
#if FMT_USE_INT128
EXPECT_EQ(fmt::format("{0:+}", __int128_t(42)),
"+42");
#endif
EXPECT_THROW_MSG((void) fmt::format(runtime("{0:+}"), 42ull), format_error,
                 "invalid format specifier");
EXPECT_EQ(fmt::format("{0:+}", 42.0),
"+42");
EXPECT_EQ(fmt::format("{0:+}", 42.0l),
"+42");
...
EXPECT_EQ(fmt::format("{0:#}", -42),
"-42");
EXPECT_EQ(fmt::format("{0:#b}", 42),
"0b101010");
EXPECT_EQ(fmt::format("{0:#B}", 42),
"0B101010");
EXPECT_EQ(fmt::format("{0:#b}", -42),
"-0b101010");
EXPECT_EQ(fmt::format("{0:#x}", 0x42),
"0x42");
EXPECT_EQ(fmt::format("{0:#X}", 0x42),
"0X42");
EXPECT_EQ(fmt::format("{0:#x}", -0x42),
"-0x42");
EXPECT_EQ(fmt::format("{0:#o}", 0),
"0");
EXPECT_EQ(fmt::format("{0:#o}", 042),
"042");
EXPECT_EQ(fmt::format("{0:#o}", -042),
"-042");
EXPECT_EQ(fmt::format("{0:#}", 42u),
"42");
EXPECT_EQ(fmt::format("{0:#x}", 0x42u),
"0x42");
EXPECT_EQ(fmt::format("{0:#o}", 042u),
"042");

EXPECT_EQ(fmt::format("{0:#}", -42l),
"-42");
EXPECT_EQ(fmt::format("{0:#x}", 0x42l),
"0x42");
EXPECT_EQ(fmt::format("{0:#x}", -0x42l),
"-0x42");
EXPECT_EQ(fmt::format("{0:#o}", 042l),
"042");
EXPECT_EQ(fmt::format("{0:#o}", -042l),
"-042");
EXPECT_EQ(fmt::format("{0:#}", 42ul),
"42");
EXPECT_EQ(fmt::format("{0:#x}", 0x42ul),
"0x42");
EXPECT_EQ(fmt::format("{0:#o}", 042ul),
"042");

EXPECT_EQ(fmt::format("{0:#}", -42ll),
"-42");
EXPECT_EQ(fmt::format("{0:#x}", 0x42ll),
"0x42");
EXPECT_EQ(fmt::format("{0:#x}", -0x42ll),
"-0x42");
EXPECT_EQ(fmt::format("{0:#o}", 042ll),
"042");
EXPECT_EQ(fmt::format("{0:#o}", -042ll),
"-042");
EXPECT_EQ(fmt::format("{0:#}", 42ull),
"42");
EXPECT_EQ(fmt::format("{0:#x}", 0x42ull),
"0x42");
EXPECT_EQ(fmt::format("{0:#o}", 042ull),
"042");
...
EXPECT_EQ(fmt::format("{0:#}", -42.0l),
"-42.");
EXPECT_EQ(fmt::format("{:#.0e}", 42.0),
"4.e+01");
EXPECT_EQ(fmt::format("{:#.0f}", 0.01),
"0.");
EXPECT_EQ(fmt::format("{:#.2g}", 0.5),
"0.50");
EXPECT_EQ(fmt::format("{:#.0f}", 0.5),
"0.");
EXPECT_THROW_MSG((void) fmt::format(runtime("{0:#"), 'c'), format_error,
...
EXPECT_EQ(fmt::format("{0:0}", 42),
"42");
EXPECT_EQ(fmt::format("{0:05}", -42),
"-0042");
EXPECT_EQ(fmt::format("{0:05}", 42u),
"00042");
EXPECT_EQ(fmt::format("{0:05}", -42l),
"-0042");
EXPECT_EQ(fmt::format("{0:05}", 42ul),
"00042");
EXPECT_EQ(fmt::format("{0:05}", -42ll),
"-0042");
EXPECT_EQ(fmt::format("{0:05}", 42ull),
"00042");
EXPECT_EQ(fmt::format("{0:07}", -42.0),
"-000042");
EXPECT_EQ(fmt::format("{0:07}", -42.0l),
"-000042");
...
EXPECT_EQ(fmt::format("{:4}", -42),
" -42");
EXPECT_EQ(fmt::format("{:5}", 42u),
"   42");
EXPECT_EQ(fmt::format("{:6}", -42l),
"   -42");
EXPECT_EQ(fmt::format("{:7}", 42ul),
"     42");
EXPECT_EQ(fmt::format("{:6}", -42ll),
"   -42");
EXPECT_EQ(fmt::format("{:7}", 42ull),
"     42");
EXPECT_EQ(fmt::format("{:8}", -1.23),
"   -1.23");
EXPECT_EQ(fmt::format("{:9}", -1.23l),
"    -1.23");
EXPECT_EQ(fmt::format("{:10}", reinterpret_cast<void *>(0xcafe)),
"    0xcafe");
EXPECT_EQ(fmt::format("{:11}", 'x'),
"x          ");
EXPECT_EQ(fmt::format("{:12}", "str"),
"str         ");
...
EXPECT_EQ(fmt::format("{0:{1}}", -42, 4),
" -42");
EXPECT_EQ(fmt::format("{0:{1}}", 42u, 5),
"   42");
EXPECT_EQ(fmt::format("{0:{1}}", -42l, 6),
"   -42");
EXPECT_EQ(fmt::format("{0:{1}}", 42ul, 7),
"     42");
EXPECT_EQ(fmt::format("{0:{1}}", -42ll, 6),
"   -42");
EXPECT_EQ(fmt::format("{0:{1}}", 42ull, 7),
"     42");
EXPECT_EQ(fmt::format("{0:{1}}", -1.23, 8),
"   -1.23");
EXPECT_EQ(fmt::format("{0:{1}}", -1.23l, 9),
"    -1.23");
EXPECT_EQ("    0xcafe",
fmt::format("{0:{1}}", reinterpret_cast<void *>(0xcafe), 10));
EXPECT_EQ(fmt::format("{0:{1}}", 'x', 11),
"x          ");
EXPECT_EQ(fmt::format("{0:{1}}", "str", 12),
"str         ");
...
EXPECT_THROW_MSG((void) fmt::format(runtime("{0:3.0}"), 'x'), format_error,
                 "invalid format specifier");
EXPECT_EQ(fmt::format("{0:.2}", 1.2345),
"1.2");
EXPECT_EQ(fmt::format("{0:.2}", 1.2345l),
"1.2");
EXPECT_EQ(fmt::format("{:.2}", 1.234e56),
"1.2e+56");
EXPECT_EQ(fmt::format("{0:.3}", 1.1),
"1.1");
EXPECT_EQ(fmt::format("{:.0e}", 1.0L),
"1e+00");
EXPECT_EQ(fmt::format("{:9.1e}", 0.0),
"  0.0e+00");
EXPECT_EQ(
...
EXPECT_EQ(fmt::format("{:#.0f}", 123.0),
"123.");
EXPECT_EQ(fmt::format("{:.02f}", 1.234),
"1.23");
EXPECT_EQ(fmt::format("{:.1g}", 0.001),
"0.001");
EXPECT_EQ(fmt::format("{}", 1019666432.0f),
"1019666400");
EXPECT_EQ(fmt::format("{:.0e}", 9.5),
"1e+01");
EXPECT_EQ(fmt::format("{:.1e}", 1e-34),
"1.0e-34");
...
EXPECT_EQ(fmt::format("{0:.2}", "str"),
"st");
EXPECT_EQ(fmt::format("{0:.5}", "вожыкі"),
"вожык");
EXPECT_EQ(fmt::format("{0:.6}", "123456\xad"),
"123456");
}
...
EXPECT_THROW_MSG((void) fmt::format(runtime("{0:3.{1}}"), 'x', 0),
                 format_error, "invalid format specifier");
EXPECT_EQ(fmt::format("{0:.{1}}", 1.2345, 2),
"1.2");
EXPECT_EQ(fmt::format("{1:.{0}}", 2, 1.2345l),
"1.2");
...
EXPECT_EQ(fmt::format("{0:.{1}}", "str", 2),
"st");
}

TEST(format_test, format_bool
) {
EXPECT_EQ(fmt::format("{}", true),
"true");
EXPECT_EQ(fmt::format("{}", false),
"false");
EXPECT_EQ(fmt::format("{:d}", true),
"1");
EXPECT_EQ(fmt::format("{:5}", true),
"true ");
EXPECT_EQ(fmt::format("{:s}", true),
"true");
EXPECT_EQ(fmt::format("{:s}", false),
"false");
EXPECT_EQ(fmt::format("{:6s}", false),
"false ");
...
short s = 42;
EXPECT_EQ(fmt::format("{0:d}", s),
"42");
unsigned short us = 42;
EXPECT_EQ(fmt::format("{0:d}", us),
"42");
}
...
EXPECT_EQ(fmt::format("{:c}", static_cast<int>('x')),
"x");
}

TEST(format_test, format_bin
) {
EXPECT_EQ(fmt::format("{0:b}", 0),
"0");
EXPECT_EQ(fmt::format("{0:b}", 42),
"101010");
EXPECT_EQ(fmt::format("{0:b}", 42u),
"101010");
EXPECT_EQ(fmt::format("{0:b}", -42),
"-101010");
EXPECT_EQ(fmt::format("{0:b}", 12345),
"11000000111001");
...
"42>");
EXPECT_EQ(fmt::format("{0:d}", 42),
"42");
EXPECT_EQ(fmt::format("{0}", 42u),
"42");
EXPECT_EQ(fmt::format("{0}", -42),
"-42");
EXPECT_EQ(fmt::format("{0}", 12345),
"12345");
EXPECT_EQ(fmt::format("{0}", 67890),
"67890");
#if FMT_USE_INT128
EXPECT_EQ(fmt::format("{0}", static_cast<__int128_t>(0)),
"0");
EXPECT_EQ(fmt::format("{0}", static_cast<__uint128_t>(0)),
"0");
...
EXPECT_EQ(fmt::format("{0:x}", -0x42),
"-42");
EXPECT_EQ(fmt::format("{0:x}", 0x12345678),
"12345678");
EXPECT_EQ(fmt::format("{0:x}", 0x90abcdef),
"90abcdef");
EXPECT_EQ(fmt::format("{0:X}", 0x12345678),
"12345678");
EXPECT_EQ(fmt::format("{0:X}", 0x90ABCDEF),
"90ABCDEF");
#if FMT_USE_INT128
EXPECT_EQ(fmt::format("{0:x}", static_cast<__int128_t>(0)),
"0");
EXPECT_EQ(fmt::format("{0:x}", static_cast<__uint128_t>(0)),
"0");
...
EXPECT_EQ(fmt::format("{0:o}", -042),
"-42");
EXPECT_EQ(fmt::format("{0:o}", 012345670),
"12345670");
#if FMT_USE_INT128
EXPECT_EQ(fmt::format("{0:o}", static_cast<__int128_t>(0)),
"0");
EXPECT_EQ(fmt::format("{0:o}", static_cast<__uint128_t>(0)),
"0");
...
EXPECT_EQ(fmt::format("{:L}", 1234),
"1234");
}

TEST(format_test, format_float
) {
EXPECT_EQ(fmt::format("{}", 0.0f),
"0");
EXPECT_EQ(fmt::format("{0:f}", 392.5f),
"392.500000");
}
...
EXPECT_EQ(fmt::format("{:.10a}", xd),
"0x1.ffffffffffp+2");
EXPECT_EQ(fmt::format("{:.9a}", xd),
"0x2.000000000p+2");
...
"0xf.ffffffffffp-3");
EXPECT_EQ(fmt::format("{:.10a}", ld),
"0xf.ffffffffffp-3");
EXPECT_EQ(fmt::format("{:.9a}", ld),
"0x1.000000000p+1");
}
#endif
...
EXPECT_EQ(fmt::format("{:.0f}", 0.0),
"0");
EXPECT_EQ(fmt::format("{:.0f}", 0.01),
"0");
EXPECT_EQ(fmt::format("{:.0f}", 0.1),
"0");
EXPECT_EQ(fmt::format("{:.3f}", 0.00049),
"0.000");
EXPECT_EQ(fmt::format("{:.3f}", 0.0005),
"0.001");
EXPECT_EQ(fmt::format("{:.3f}", 0.00149),
"0.001");
EXPECT_EQ(fmt::format("{:.3f}", 0.0015),
"0.002");
EXPECT_EQ(fmt::format("{:.3f}", 0.9999),
"1.000");
EXPECT_EQ(fmt::format("{:.3}", 0.00123),
"0.00123");
EXPECT_EQ(fmt::format("{:.16g}", 0.1),
"0.1");
EXPECT_EQ(fmt::format("{:.0}", 1.0),
"1");
EXPECT_EQ("225.51575035152063720",
fmt::format("{:.17f}", 225.51575035152064));
EXPECT_EQ(fmt::format("{:.1f}", -761519619559038.2),
"-761519619559038.2");
EXPECT_EQ("1.9156918820264798e-56",
fmt::format("{}", 1.9156918820264798e-56));
EXPECT_EQ(fmt::format("{:.4f}", 7.2809479766055470e-15),
"0.0000");
}

TEST(format_test, prettify_float
) {
EXPECT_EQ(fmt::format("{}", 1e-4),
"0.0001");
EXPECT_EQ(fmt::format("{}", 1e-5),
"1e-05");
EXPECT_EQ(fmt::format("{}", 1e15),
"1000000000000000");
EXPECT_EQ(fmt::format("{}", 1e16),
"1e+16");
EXPECT_EQ(fmt::format("{}", 9.999e-5),
"9.999e-05");
EXPECT_EQ(fmt::format("{}", 1e10),
"10000000000");
EXPECT_EQ(fmt::format("{}", 1e11),
"100000000000");
EXPECT_EQ(fmt::format("{}", 1234e7),
"12340000000");
EXPECT_EQ(fmt::format("{}", 1234e-2),
"12.34");
EXPECT_EQ(fmt::format("{}", 1234e-6),
"0.001234");
EXPECT_EQ(fmt::format("{}", 0.1f),
"0.1");
EXPECT_EQ(fmt::format("{}", 1.35631564e-19f),
"1.3563156e-19");
}
...
EXPECT_EQ(fmt::format("{}", nan),
"nan");
EXPECT_EQ(fmt::format("{:+}", nan),
"+nan");
EXPECT_EQ(fmt::format("{:+06}", nan),
"  +nan");
EXPECT_EQ(fmt::format("{:<+06}", nan),
"+nan  ");
EXPECT_EQ(fmt::format("{:^+06}", nan),
...
EXPECT_EQ(fmt::format("{: }", nan),
" nan");
EXPECT_EQ(fmt::format("{:F}", nan),
"NAN");
EXPECT_EQ(fmt::format("{:<7}", nan),
"nan    ");
EXPECT_EQ(fmt::format("{:^7}", nan),
"  nan  ");
EXPECT_EQ(fmt::format("{:>7}", nan),
...
EXPECT_EQ(fmt::format("{}", inf),
"inf");
EXPECT_EQ(fmt::format("{:+}", inf),
"+inf");
EXPECT_EQ(fmt::format("{}", -inf),
"-inf");
EXPECT_EQ(fmt::format("{:+06}", inf),
"  +inf");
EXPECT_EQ(fmt::format("{:+06}", -inf),
"  -inf");
EXPECT_EQ(fmt::format("{:<+06}", inf),
...
EXPECT_EQ(fmt::format("{: }", inf),
" inf");
EXPECT_EQ(fmt::format("{:F}", inf),
"INF");
EXPECT_EQ(fmt::format("{:<7}", inf),
"inf    ");
EXPECT_EQ(fmt::format("{:^7}", inf),
"  inf  ");
EXPECT_EQ(fmt::format("{:>7}", inf),
...
EXPECT_EQ(fmt::format("{0:}", 0.0l),
"0");
EXPECT_EQ(fmt::format("{0:f}", 0.0l),
"0.000000");
EXPECT_EQ(fmt::format("{:.1f}", 0.000000001l),
"0.0");
EXPECT_EQ(fmt::format("{:.2f}", 0.099l),
"0.10");
EXPECT_EQ(fmt::format("{0:}", 392.65l),
"392.65");
EXPECT_EQ(fmt::format("{0:g}", 392.65l),
"392.65");
EXPECT_EQ(fmt::format("{0:G}", 392.65l),
"392.65");
EXPECT_EQ(fmt::format("{0:f}", 392.65l),
"392.650000");
EXPECT_EQ(fmt::format("{0:F}", 392.65l),
"392.650000");
char buffer[buffer_size];
...
EXPECT_EQ(fmt::format("{0:+010.4g}", 392.64l),
"+0000392.6");
...
EXPECT_EQ(fmt::format("{0}", 'a'),
"a");
EXPECT_EQ(fmt::format("{0:c}", 'z'),
"z");
int n = 'x';
for (
...
volatile char c = 'x';
EXPECT_EQ(fmt::format("{}", c),
"x");
}

TEST(format_test, format_unsigned_char
) {
EXPECT_EQ(fmt::format("{}", static_cast<unsigned char>(42)),
"42");
EXPECT_EQ(fmt::format("{}", static_cast<uint8_t>(42)),
"42");
}
...
EXPECT_EQ(fmt::format("{0}", "test"),
"test");
EXPECT_EQ(fmt::format("{0:s}", "test"),
"test");
char nonconst[] = "nonconst";
EXPECT_EQ(fmt::format("{0}", nonconst),
"nonconst");
...
EXPECT_EQ(fmt::format("{0}", static_cast<void *>(nullptr)),
"0x0");
EXPECT_EQ(fmt::format("{0}", reinterpret_cast<void *>(0x1234)),
"0x1234");
EXPECT_EQ(fmt::format("{0:p}", reinterpret_cast<void *>(0x1234)),
"0x1234");
...
EXPECT_EQ(fmt::format("{}", string_view("test")),
"test");
...
EXPECT_EQ(fmt::format("{}", std::string_view("test")),
"test");
EXPECT_EQ(fmt::format("{}", string_viewable()),
"foo");
}
...
EXPECT_EQ(fmt::format("{0}", Answer()),
"42");
EXPECT_EQ(fmt::format("{:04}", Answer()),
"0042");
}
...
EXPECT_EQ(fmt::format("From {} to {}", 1, 3),
"From 1 to 3");
...
EXPECT_EQ(fmt::format("{0}, {1}, {2}", 'a', 'b', 'c'),
"a, b, c");
EXPECT_EQ(fmt::format("{}, {}, {}", 'a', 'b', 'c'),
"a, b, c");
EXPECT_EQ(fmt::format("{2}, {1}, {0}", 'a', 'b', 'c'),
"c, b, a");
EXPECT_EQ(fmt::format("{0}{1}{0}", "abra", "cad"),
"abracadabra");
...
EXPECT_EQ(fmt::format("The answer is {}", 42),
"The answer is 42");
EXPECT_THROW_MSG(
...
EXPECT_EQ(fmt::format("{:>16.2f}", point{1, 2}),
"    (1.00, 2.00)");
}
...
EXPECT_EQ(fmt::format("({})", join(v1, v1 + 3, ", ")),
"(1, 2, 3)");
EXPECT_EQ(fmt::format("({})", join(v1, v1 + 1, ", ")),
"(1)");
EXPECT_EQ(fmt::format("({})", join(v1, v1, ", ")),
"()");
EXPECT_EQ(fmt::format("({:03})", join(v1, v1 + 3, ", ")),
"(001, 002, 003)");
...
EXPECT_EQ(fmt::format("{0:{1}}", join(v1, v1 + 3, ", "), 1),
"1, 2, 3");
...
EXPECT_EQ(fmt::format("({})", join(v1, ", ")),
"(1, 2, 3)");
EXPECT_EQ(fmt::format("({:+06.2f})", join(v2, ", ")),
"(+01.20, +03.40)");

auto v4 = std::vector<test_enum>{foo, bar, foo};
EXPECT_EQ(fmt::format("{}", join(v4, " ")),
"0 1 0");
}
...
EXPECT_EQ(fmt::format(FMT_STRING("foo")),
"foo");
EXPECT_EQ(fmt::format(FMT_STRING("{}"), 42),
"42");
...
static_no_null;
#ifndef _MSC_VER
EXPECT_EQ(fmt::format(FMT_STRING(static_with_null), 42),
"42");
EXPECT_EQ(fmt::format(FMT_STRING(static_no_null), 42),
"42");
#endif
...
no_null;
#if FMT_CPLUSPLUS >= 201703L
EXPECT_EQ(fmt::format(FMT_STRING(with_null), 42),
"42");
EXPECT_EQ(fmt::format(FMT_STRING(no_null), 42),
"42");
#endif
#if defined(FMT_USE_STRING_VIEW) && FMT_CPLUSPLUS >= 201703L
EXPECT_EQ(fmt::format(FMT_STRING(std::string_view("{}")), 42),
"42");
#endif
}
...
EXPECT_EQ(fmt::format(FMT_STRING("{}"), Answer()),
"42");
auto answer = Answer();
EXPECT_EQ(fmt::format(FMT_STRING("{}"), answer),
"42");
...
EXPECT_EQ(fmt::format(FMT_STRING("{}"), const_answer),
"42");
}
...
"42");
EXPECT_EQ(fmt::format("{}", test::struct_as_const_reference()),
"foo");
}

TEST(format_test, format_as_to_string
) {
EXPECT_EQ(fmt::to_string(test::scoped_enum_as_int()),

"42");

EXPECT_EQ(fmt::to_string(test::scoped_enum_as_string_view()),

"foo");

EXPECT_EQ(fmt::to_string(test::scoped_enum_as_string()),
...
EXPECT_EQ(std::string(format_int.data(), format_int.size()),
"42");
}

TEST(format_int_test, format_int
) {
EXPECT_EQ(fmt::format_int(42)
.
...
3u);
EXPECT_EQ(fmt::format_int(42ul)
.

str(),

"42");
EXPECT_EQ(fmt::format_int(-42l)
.

str(),

"-42");
EXPECT_EQ(fmt::format_int(42ull)
.

str(),

"42");
EXPECT_EQ(fmt::format_int(-42ll)
.
...
EXPECT_EQ(fmt::format_int(max_value<int64_t>())
.
...
EXPECT_EQ(fmt::format("{}", convertible_to_nonconst_cstring()),
"bar");
}
